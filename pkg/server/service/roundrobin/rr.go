...
func EnableStickySession(stickySession *roundrobin.StickySession) LBOption {
	return func(s *RoundRobin) error {
...
func RoundRobinRequestRewriteListener(rrl roundrobin.RequestRewriteListener) LBOption {
	return func(s *RoundRobin) error {
...
type RoundRobin struct {
	...
	servers                []*server
	currentWeight          int
	stickySession          *roundrobin.StickySession
